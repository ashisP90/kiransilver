...
class Orders_model extends MY_Model
{
    ...
    public function getOrders(){
    	$this->db->select('o.*, c.first_name, c.last_name, c.email, c.mobile, od.order_id as od_order_id,
        ...
        $this->db->join($this->order_details.' as od', 'od.order_id = o.id', 'left');
	...
	public function getOrderItemDetails($orders_id){
