...
<html>
    ...
    <body class="theme-red">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="body">         
                                <?php
                                $id = $_GET['id'];
                                $sql = "SELECT * FROM slider where sr_no='$id'";
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 ">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="varchar" name="description1" value="<?php echo $description1; ?>" class="form-control" placeholder="Text" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 ">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="varchar" name="description2" value="<?php echo $description2; ?>" class="form-control" placeholder="Link" />
                                                </div>
                                            </div>
                                        </div>
        ...
        <script src="../../js/pages/header-section/slider_section.js"></script>
    </body>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "UPDATE slider SET description1='$description1',description2='$description2' where sr_no='$id'";
    ...
    if (isset($_POST['submit1'])) {
        ...
        $sql = "UPDATE slider SET image='$image' where sr_no='$id'";

        if (mysqli_query($conn, $sql)) {
            echo "New record created successfully";
            echo'<script>window.location="edit_slider_sec.php?id=' . $id . '";</script>';
        } else {
            echo "Error: " . $sql . "<br>" . mysqli_error($conn);
        }
    }
