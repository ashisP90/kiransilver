...
<html>
    ...
    <body class="theme-red">
                            ...
                            <div class="body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = "SELECT * FROM associate_member";
                                            ...
                                            <tr>
                                                ...
                                                <td class="justify-content-between text-center">
                                                    <button class="btn btn-sm btn-primary  btn-sm waves-effect" type="button" data-toggle="modal" data-target="#editAssociateMemberModal">Edit</button>
                                                    <a href="delete_associate_member.php?id=<?php echo $id; ?>"><button type="button" class="delete btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash">&nbsp;Delete</span></button></a>
        ...
        <!-- EDIT ASSOCIATE MEMBER DETAILS -->
        <div class="modal fade" id="editAssociateMemberModal" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Edit Associate Members</h4>
                    </div>
        ...
        <script src="../../js/pages/home-page/associate-members.js"></script>
    </body>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO associate_member (member_name,image) values ('$member_name','$image')";

        if (mysqli_query($conn, $sql)) {
            echo "New record created successfully";
            echo'<script>window.location="associate-members.php";</script>';
        } else {
