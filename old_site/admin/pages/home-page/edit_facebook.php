...
<html>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="body"> 
                                <?php
                                $id = $_GET['id'];
                                $sql = "SELECT * FROM instagram where sr_no='$id'";
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 ">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="varchar" name="photo_name" value="<?php echo $photo_name; ?>" class="form-control" placeholder="Link" />
                                                </div>
                                            </div>
                                        </div>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "UPDATE instagram SET photo_name='$photo_name' where sr_no='$id'";
  ...
  <?php
    if (isset($_POST['submit1'])) {
        ...
        $sql = "UPDATE instagram SET image='$image' where sr_no='$id'";

        if (mysqli_query($conn, $sql)) {
            echo "New record created successfully";
            echo'<script>window.location="edit_facebook.php?id=' . $id . '";</script>';
        } else {
            echo "Error: " . $sql . "<br>" . mysqli_error($conn);
        }
    }
