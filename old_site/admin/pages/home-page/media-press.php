...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO media_press (news_title,description,image) values ('$news_title','$description','$image')";
...
<!--                                        <div class="col-3 col-sm-3 col-md-4 col-lg-11 d-flex flex-row justify-content-between">
                                            <div class="form-group d-flex flex-column ">
                                                <label class="label-text">Upload Video</label>
                                        ...
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 ">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" class="form-control" placeholder="YouTube Link" name="news_title" />
                                                </div>
                                            </div>
                                        </div>
...
<!--                                                <td>
                                                ...
                                                <td class="justify-content-between text-center">
                                                    <a href="edit_media.php?id=<?php echo $id; ?>"><button class="btn btn-sm btn-primary  btn-sm waves-effect" type="button" data-toggle="modal" data-target="#editMediaPressModal"><span class="glyphicon glyphicon-edit"></span></button></a>
                                                    <a href="delete_media_press.php?id=<?php echo $id; ?>"><button type="button" class="delete btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span></button></a>                                                
                                                </td>	
                                            </tr>
                                            <?php
                                            }
