                ...
                <div class="offcanvas_menu_wrapper">
                    ...
                    <div class="search_bar">
                        <form action="#">
                            ...
                            <input  type="text" placeholder="Search by Product code / Product name " >
                    ...
                    <div class="cart_area">
                        ...
                        <?php include('includes/header/mini-cart.php'); ?>
                ...
                <div class="col-lg-12 col-md-12 top-right-header">
                    <div class="top_right text-right">
                        <ul id="nomoremargin1">
                            ...
                            <li><a href="login.php">Login</a></li>
                            <li>|</li>
                            <li class="language"><a href="register.php"> Register</a></li>
                            <!-- <ul class="dropdown_links">
                                <li><a href="wishlist.html">My Wish List </a></li>
...
<!-- <input  type="text" id="tags" placeholder="Search by Product code / Product name."> -->
                            <input type="text" id="myAutocomplete" placeholder="Search by Product code / Product name."></input>
                            <button type="submit"><i class="ion-ios-search-strong"></i></button>
                        </form>
                    </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 setcartandwishlist">
                                    ...
                                    <div class="cart_link">
                                        <a href="cart.php"><i class="fa fa-shopping-basket"></i><b id="cart_text">10 items</b></a>
                                        <!--<a href="cart.php"><i class="fa fa-shopping-basket"></i>2 item(s)</a>-->
                                        <div class="mini_cart">
                                            <div class="cart_item top">
                                                <div class="cart_img">
                                    ...
                                    <div class="cart_link">
                                        <a href="wishlist.php"><i class="fa fa-heart-o"></i><b id="cart_text">20 items</b></a>
                                    </div>
                                </div>
...
<div id="liveSilver">
    <p id="SilverTitle">Live Silve Price</p>
    <p>678 rs</p>
</div>