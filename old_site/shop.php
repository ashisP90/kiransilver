                            ...
                            <div class="sidebar_widget">
                                ...
                                <div class="widget_list widget_categories">
                                    ...
                                    <ul class="nav" id="needblock" role="tablist">
                                        ...
                                        <li><a data-toggle="tab" href="#menu1" role="tab" aria-controls="menu1" aria-selected="true"><input type="checkbox" id="vehicle1" name="vehicle1" value="">&nbsp; T100 Utensils <span>6</span></a> </li> <br>
                                        <li><a data-toggle="tab" href="#menu2" role="tab" aria-controls="menu2" aria-selected="false" id="needmargintop"><input type="checkbox" id="vehicle1" name="vehicle1" value="">&nbsp; 925 Articles <span>10</span></a> </li>
                                        <li><a data-toggle="tab" href="#menu3" role="tab" aria-controls="menu3" aria-selected="false"><input type="checkbox" id="vehicle1" name="vehicle1" value="">&nbsp; 835 Articles <span>4</span></a> </li>
                                        <li><a data-toggle="tab" href="#menu4" role="tab" aria-controls="menu4" aria-selected="false"><input type="checkbox" id="vehicle1" name="vehicle1" value="">&nbsp; Nathdwara Articles <span>4</span></a> </li>
                                        <li><a data-toggle="tab" href="#menu5" role="tab" aria-controls="menu5" aria-selected="false"><input type="checkbox" id="vehicle1" name="vehicle1" value="">&nbsp; Kolhapur Articles <span>3</span></a> </li>
                                        <li><a data-toggle="tab" href="#menu6" role="tab" aria-controls="menu6" aria-selected="false"><input type="checkbox" id="vehicle1" name="vehicle1" value="">&nbsp; Jain Pooja Articles  <span>3</span></a> </li>
                                        <li><a data-toggle="tab" href="#menu7" role="tab" aria-controls="menu7" aria-selected="false"><input type="checkbox" id="vehicle1" name="vehicle1" value="">&nbsp; Kolhapur Articles 3  <span>3</span></a> </li>
                                        <li><a data-toggle="tab" href="#menu8" role="tab" aria-controls="menu8" aria-selected="false"><input type="checkbox" id="vehicle1" name="vehicle1" value="">&nbsp; Reg.Jewellery  <span>3</span></a> </li>
                                        <li><a data-toggle="tab" href="#menu9" role="tab" aria-controls="menu9" aria-selected="false"><input type="checkbox" id="vehicle1" name="vehicle1" value="">&nbsp; 925 Jewellery  <span>3</span></a> </li>
                                        <li><a data-toggle="tab" href="#menu10" role="tab" aria-controls="menu10" aria-selected="false"><input type="checkbox" id="vehicle1" name="vehicle1" value="">&nbsp; Frames (999)  <span>3</span></a> </li>
                                        <li><a data-toggle="tab" href="#menu11" role="tab" aria-controls="menu11" aria-selected="false"><input type="checkbox" id="vehicle1" name="vehicle1" value="">&nbsp; Pure Chap<span>3</span></a> </li>
                                        <li><a data-toggle="tab" href="#menu12" role="tab" aria-controls="menu12" aria-selected="false"><input type="checkbox" id="vehicle1" name="vehicle1" value="">&nbsp; Ganpati Items<span>3</span></a> </li>
                                        <li><a data-toggle="tab" href="#menu13" role="tab" aria-controls="menu13" aria-selected="false"><input type="checkbox" id="vehicle1" name="vehicle1" value="">&nbsp; Coins Pure<span>3</span></a> </li>
                                    ...
                                    <div class="container-fluid tab-pane fade show active" id="menu1" role="tabpanel" >
                                        <div class="row " id="paddingCategory">
                                            <div class="col-lg-6 col-md-6">
                                                <div class="banner_area">
                                                    <div class="banner_thumb">
                                                        <a href="shop-sub-categories.php"><img src="assets/img/bg/background/1.png" alt="#"></a>
                                                        <div class="banner_content">
                                                            <h1> 1st SUB MENU </h1>
                                                            <a href="shop-sub-categories.php">Discover Now</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                                                <div class="banner_area">
                                                    <div class="banner_thumb">
                                                        <a href="shop-sub-categories.php"><img src="assets/img/bg/background/2.png" alt="#"></a>
                                                        <div class="banner_content">
                                                            <h1> 1st SUB MENU </h1>
                                                            <a href="shop-sub-categories.php">Discover Now</a>
                                                        </div>
                                        ...
                                        <div class="row" id="paddingCategory">
                                            <div class="col-lg-6 col-md-6">
                                                <div class="banner_area">
                                                    <div class="banner_thumb">
                                                        <a href="shop-sub-categories.php"><img src="assets/img/bg/background/3.png" alt="#"></a>
                                                        <div class="banner_content">
                                                            <h1> 1st SUB MENU </h1>
                                                            <a href="shop-sub-categories.php">Discover Now</a>
                                                        </div>
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="banner_area">
                                                    <div class="banner_thumb">
                                                        <a href="shop-sub-categories.php"><img src="assets/img/bg/background/4.png" alt="#"></a>
                                                        <div class="banner_content">
                                                            <h1> 1st SUB MENU </h1>
                                                            <a href="shop-sub-categories.php">Discover Now</a>
                                                        </div>
